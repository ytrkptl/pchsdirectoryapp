...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        boolean isFav = currentWord.getIsFavorite();
        ImageView imageView1 = convertView.findViewById(R.id.favorite_image_view);
        if (isFav) {
            imageView1.setImageResource(R.drawable.baseline_star_black_36);
        } else {
            imageView1.setImageResource(R.drawable.baseline_star_border_black_36);
        }
